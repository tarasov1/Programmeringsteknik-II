...
public class Stokenizer extends StreamTokenizer {
 ...
 /**
  * Creates a <code>TsTokenizer</code> and ties it to a <code>Reader</code><br>
 ...
 public int nextToken() {
  try {
   ...
   throw new RuntimeException("IOException - should not happen ...");
  }
  return ttype;
 }
  ...
  * @throws RuntimeException if the token is not a number
 ...
 public double getNumber() {
  if (isNumber()) {
   ...
   throw new RuntimeException("Illegal call to getNumber. Token: " + toString());
  }
 }

 /**
  * Returns the word in the current token provided it is a word token.
  * @throws RuntimeException if the token is not a word
 ...
 public String getWord() {
  if (isWord()) {
   ...
   throw new RuntimeException("Illegal call to getWord. Token: " + toString());
  }
 }
